...
{
    public class AlgorithmTask6 : AlgorithmPerch
    {
        public AlgorithmTask6(double U1, double U2, double x0, double x1)
        {
        ...
        public override void I(Perch perch, bool flag = false)
        {
            ...
            {
                x1.Add(x2[i]);
                x2.Add(x1[i] - perch.coords[i]);
            }

            double res1 = x1[2] * x1[2] + x2[2] * x2[2];
